...
namespace NS
{
	class RunningApplication : NS::Referencing< RunningApplication >
	{
		public:
            ...
            bool                        isFinishedLaunching() const;
	};
}
...
_NS_INLINE bool NS::RunningApplication::isFinishedLaunching() const
{
	return Object::sendMessage<bool>( this, _APPKIT_PRIVATE_SEL( isFinishedLaunching ));
}
